...
output SERVICE_APISERVER_VOLUME_HFMODELCACHE_NAME string = resources.outputs.SERVICE_APISERVER_VOLUME_HFMODELCACHE_NAME
output SERVICE_NIM_LLM_VOLUME_NIMMODELCACHE_NAME string = resources.outputs.SERVICE_NIM_LLM_VOLUME_NIMMODELCACHE_NAME
